...
fn Content(props: &Props) -> Html {
    ...
    html! {
                <div id="content">
                    <p>{"user_first_name: "}{user_first_name}</p>
                    <p>{" and user_last_name: "}{user_last_name}</p>
                    <p>{"------"}</p>
                    <p>{"message:"}{message}</p>
                </div>
    }
...
pub fn landing_page() -> Html {
    html! {
        <main>
           <div id="outer">
                <div>
                    <Content user_first_name="Luke" user_last_name="OConnell" message="Our Child" />
                </div>
                <div>
                   <PoemComponent />
                </div>
