...
impl Db {
    pub async fn list_messages(channel_id: i64, pool: &PgPool) -> Result<Vec<MessageModel>, sqlx::Error> {
        sqlx::query_as!(
            MessageModel,
    ...
    pub async fn get_message(channel_id: i64, message_id: i64, pool: &PgPool) -> Result<MessageModel, sqlx::Error> {
        sqlx::query_as!(
            MessageModel,
    ...
    pub async fn delete_message(channel_id: i64, message_id: i64, pool: &PgPool) -> Result<PgQueryResult, sqlx::Error> {
        sqlx::query!(
